...
<head>
	...
	<title>MyFin Bank - Transfer Money</title>
...
<div class="container-transfer">
	<div class="card">
		<div class="card-header-custom">
			<h4 class="mb-0">🔄 Fund Transfer</h4>
		</div>
		<div class="card-body p-4">
			<!-- Current Balance Display -->
			<div class="current-balance">
				<div class="current-balance-label">Your Current Balance</div>
			...
			<form method="post" action="${pageContext.request.contextPath}/customer/transfer">
				<div class="form-group">
					<label for="targetAccountNo">Recipient's Account Number</label>
					<input type="text"
					       id="targetAccountNo"
					       name="targetAccountNo"
					       placeholder="e.g., ACC1000001"
					       required
					       autofocus
					       style="text-transform: uppercase;"/>
					<div class="helper-text">
						✓ Enter the account number of the person you want to transfer money to
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="number"
					       ...
					       max="${customer.amount}"/>
					<div class="helper-text">
						✓ You can transfer up to ₹${customer.amount}
					</div>
				</div>
	...
	<div class="card" style="margin-top: 20px;">
		<div class="card-body p-4" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%); border-radius: 0 0 12px 12px;">
			<h6 style="color: #1f2937; font-weight: 600; margin-bottom: 10px;">📋 About Fund Transfers</h6>
			<ul style="font-size: 13px; color: #4b5563; margin-bottom: 0; padding-left: 20px;">
				<li>Transfer amount should be greater than ₹0</li>
				<li>You cannot transfer more than your current balance</li>
				<li>Recipient's account must be active</li>
				<li>You will receive a Transaction ID for this transfer</li>
