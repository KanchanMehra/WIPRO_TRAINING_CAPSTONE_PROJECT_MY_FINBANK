...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleCustomerNotFoundException(
		...
		errorResponse.addDetail("Please verify your username and try again.");
	...
	public ResponseEntity<ErrorResponse> handleInsufficientBalanceException(
		...
		errorResponse.addDetail("Please enter a lower amount or check your balance.");
	...
	public ResponseEntity<ErrorResponse> handleInvalidTransactionException(
		...
		logger.error("InvalidTransactionException: {}", ex.getMessage());
		...
		errorResponse.addDetail("Please verify the transaction details and try again.");
	...
	public ResponseEntity<ErrorResponse> handleLoanNotFoundException(
		...
		errorResponse.addDetail("The requested loan does not exist.");
